  ...
  return (
    ...
    <CustomSafeAreaView>
      <View style={orderStyles.container}>
        ...
        <View style={orderStyles.flexRow}>
          <Text style={orderStyles.subHeading}>{user ? user?.address : "Log in to get exclusive offerse"}</Text>
    ...
    renderItem={({item}) => (
      <View style={orderStyles.order}>
        ...
        <Text style={orderStyles.deliveryDate}>Delivery by: {formatDate(item?.deliveryDate)}</Text>
    ...
    <LoginModel onClose={() => setIsVisible(false)} visible={isVisible}/>
    </>
  )
}
